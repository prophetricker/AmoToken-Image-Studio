        ...
        <div className={cn("flex min-w-0 shrink-0 items-center gap-2 sm:gap-3", sidebarMode && 'xl:hidden')}>
          ...
          >
            <img
              ...
              className="amotoken-brand-mark h-8 w-8 flex-shrink-0 object-contain sm:h-11 sm:w-11"
            />
          </button>
          <div className="hidden min-w-0 space-y-1 sm:block">
            <h1 className="truncate text-2xl font-semibold tracking-tight">AmoToken Image Studio</h1>
            <p className="text-sm text-muted-foreground">爱词元 AI 生图工作台</p>
          </div>
        </div>
